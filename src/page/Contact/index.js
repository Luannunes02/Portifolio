    ...
    return (
        <section className='container-fluid' id='contactSection'>
            <div className='container'>
                <div className='row'>
                    <h1 className='col fw-bold' id='projectsTitle'  data-aos="fade-right"data-aos-duration="2000">Contato</h1>
                </div>
                <div className='row'>
                    <span className='text-center mt-3' data-aos="fade-up" data-aos-duration="1000">Entre em contato comigo usando os links logo abaixo</span>
                </div>
                <div className="row" id='socialGroup' data-aos="zoom-out-right" data-aos-duration="1000">
